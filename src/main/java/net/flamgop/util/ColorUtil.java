...
public class ColorUtil {
    public static Vector3f getRGBFromK(int temperature) {
        // this is all https://gist.github.com/stasikos/06b02d18f570fc1eaa9f
        ...
        return new Vector3f((float) red, (float) green, (float) blue);
    }
